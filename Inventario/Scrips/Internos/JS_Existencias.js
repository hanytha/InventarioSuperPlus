...
function AcordeonExistencias(Data, CtrlExistencia) {
    ...
    for (var i = 0; i < Data.length; i++) {
        ...
        CodigoHTMLAreas += "</div>";
        CodigoHTMLAreas += "<div class='row'>";
        CodigoHTMLAreas += "<div class='col-md-5 col-sm-6 col-xs-6'><strong>Tipo De Existencia: </strong>" + Data[i].TipoDeExistencia + "</div>";
        ...
        CodigoHTMLAreas += "<button class='btn btn-danger' onclick='EliminarExistencia(" + Data[i].IdExistencia + ",this)' ><i class='far fa-trash-alt'></i></button>";
        CodigoHTMLAreas += "</div>";
        CodigoHTMLAreas += "</div>";
        CodigoHTMLAreas += "</div>";
        CodigoHTMLAreas += "</div>";
